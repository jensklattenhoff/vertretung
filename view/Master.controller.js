...
sap.ui.core.mvc.Controller.extend("com.p7s1.view.Master", {
	...
	loadDetailView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.p7s1.view.Detail",
			targetViewType: "XML"
		});
	},
	...
	selectFirstItem: function() {
		...
		if (aItems.length) {
			...
			this.getRouter().myNavToWithoutHash({
				currentView: this.getView(),
				targetViewName: "com.p7s1.view.NotFound",
				targetViewType: "XML"
			});
		}
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("RepName", sap.ui.model.FilterOperator.Contains, searchString)];
		}
		// Update list binding
	...
	onAddVertretung: function(oEvent) {
		sap.m.MessageToast.show("Neue Vertretung wurde angelegt.", {duration: 6000});
